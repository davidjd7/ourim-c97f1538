...
const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { key: 'xirrUnleveraged', label: 'IRR Unleveraged', visible: false, sortable: true, align: 'right', type: 'percentage', order: 7 },
  // Nouvelles colonnes (masquées par défaut)
  { key: 'coc', label: 'COC', visible: false, sortable: true, align: 'right', type: 'percentage', order: 8 },
  { key: 'totalCfni', label: 'Total CFNI', visible: false, sortable: true, align: 'right', type: 'currency', order: 9 },
  { key: 'totalVarValeur', label: 'Total Var valeur', visible: false, sortable: true, align: 'right', type: 'currency', order: 10 },
  { key: 'lastVarValeur', label: 'Last Var. Valeur', visible: false, sortable: true, align: 'right', type: 'currency', order: 11 },
  { key: 'lastCfni', label: 'Last CFNI', visible: false, sortable: true, align: 'right', type: 'currency', order: 12 },
  { key: 'gain1', label: 'Last gain', visible: false, sortable: true, align: 'right', type: 'currency', order: 13 },
  { key: 'ltv', label: 'LTV', visible: false, sortable: true, align: 'right', type: 'percentage', order: 14 },
  { key: 'crd', label: 'CRD', visible: false, sortable: true, align: 'right', type: 'currency', order: 15 },
