...
export function InvestmentProvider({ children }: { children: ReactNode }) {
  ...
  const convertInvestmentToDb = (investment: Partial<Investment>) => {
    return {
      ...
      surface: investment.surface || null,
      ...
      duree_bail: investment.dureeBail || null,
      ...
      bail_loyer_ht: investment.bailLoyerHT || null,
      bail_cnr: investment.bailCNR || null,
      bail_prise_effet: investment.bailPriseEffet || null,
      bail_activite: investment.bailActivite || null,
      bail_anciennete: investment.bailAnciennete || null,
      net_vendeur: investment.netVendeur || null,
      agent: investment.agent || null,
      hono_notaire: investment.honoNotaire || null,
      last_value: investment.lastValue || null,
      tri: investment.tri || null,
      investment_date: investment.dateInvestment || null,
      investment_amount: investment.investmentAmount || null,
      notary_fees: investment.notaryFees || null,
